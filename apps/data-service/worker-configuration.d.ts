/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv --env stage` (hash: 4a2ab92eeb0705b0e00655206212290f)
// Runtime types generated with workerd@1.20260317.1 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EvaluationSchedular" | "LinkClickTracker";
	}
	interface Env {
		KV: KVNamespace;
		BUCKET: R2Bucket;
		...
		AI: Ai;
		EVALUATION_SCHEDULAR: DurableObjectNamespace<import("./src/index").EvaluationSchedular>;
		LINK_CLICK_TRACKER_OBJECT: DurableObjectNamespace<import("./src/index").LinkClickTracker>;
		DESTINATION_EVALUATION_WORKFLOW: Workflow<Parameters<import("./src/index").DestinationEvaluationWorkflow['run']>[0]['payload']>;
	}
}
